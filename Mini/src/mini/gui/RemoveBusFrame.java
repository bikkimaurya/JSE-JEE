 ...
 */
public class RemoveBusFrame extends javax.swing.JFrame {

    /**
     * Creates new form RemoveBusFrame
     */
    public RemoveBusFrame() {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveBusFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveBusFrame().setVisible(true);
            }
        });
    }
