                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    ...
                                    .addComponent(txtEmpSal, javax.swing.GroupLayout.DEFAULT_SIZE, 150, Short.MAX_VALUE)))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(138, 138, 138)
...
this.dispose();
    ...
    String sal =txtEmpSal.getText().trim();
    if(eno.isEmpty() || ename.isEmpty() || sal.isEmpty())
    {
        ...
        try
        {
            if(EmpDao.updateEmp(Integer.parseInt(eno), ename, Double.parseDouble(sal))==true)
                JOptionPane.showMessageDialog(null, "updated successfully","Done", JOptionPane.INFORMATION_MESSAGE);
            else
                                JOptionPane.showMessageDialog(null, "id not found","worning", JOptionPane.INFORMATION_MESSAGE);
            
        }
        catch (SQLException ex) 
        {
            ex.printStackTrace();
      JOptionPane.showMessageDialog(null, "sql exception","worning", JOptionPane.ERROR);
        }
        catch(NumberFormatException ex)
        {
                ex.printStackTrace();
      JOptionPane.showMessageDialog(null, "input vailid values","worning", JOptionPane.ERROR);
        }
